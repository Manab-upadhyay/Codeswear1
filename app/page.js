...
export default function Home() {
  ...
  <Image src={img} className="object-cover md:w-full h-full w-80  rounded-lg" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center md:w-full w-60 mb-20">
    ...
    <div className="flex flex-wrap">
      <div className="xl:w-1/4 lg:w-1/2 md:w-full w-60 px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
