          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit}className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div className="flex items-center justify-between">
                      ...
                      <Link href={"/forgotpas"} className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"><div>Forgot password</div></Link> 
                  </div>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <Link href={"/login"} className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"><div>Sign up</div></Link>
                  </p>
              </form>
          </div>
      </div>
